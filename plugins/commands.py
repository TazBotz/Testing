...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
                    InlineKeyboardButton('➕ Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ Gʀᴏᴜᴘꜱ ➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
                ],[
                    ...
                    InlineKeyboardButton('💰 Eᴀʀɴ ᴍᴏɴᴇʏ ʙʏ ᴛʜɪꜱ Bᴏᴛ 💰', callback_data='earn_money')
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton('🧑🏻‍💻 Bᴏᴛ Oᴡɴᴇʀ 🧑🏻‍💻', url='https://t.me/LazyPrince_Bot')
                         ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            filesarr.append(msg)
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️Fɪʟᴇ Dᴇʟᴇᴛɪᴏɴ Aʟᴇʀᴛ❗️️❗️❗️</u></b>\n\nᴛʜᴇꜱᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇꜱ/ᴠɪᴅᴇᴏꜱ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.\n\n<b><i>ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴀʟʟ ꜰɪʟᴇꜱ/ᴠɪᴅᴇᴏꜱ ᴛᴏ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇꜱ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʜᴇʀᴇ.</i></b>")
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b><u>❗️❗️❗️Fɪʟᴇ Dᴇʟᴇᴛɪᴏɴ Aʟᴇʀᴛ❗️️❗️❗️</u></b>\n\nᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u>10 ᴍɪɴꜱ</u> 🫥 <i></b>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ)</i>.\n\n<b><i>ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇꜱ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʜᴇʀᴇ.</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
...
async def requests(bot, message):
    ...
    if message.reply_to_message and SUPPORT_CHAT_ID == message.chat.id:
        ...
        try:
            if REQST_CHANNEL is not None:
                ...
                reported_post = await bot.send_message(chat_id=REQST_CHANNEL, text=f"<b>Rᴇᴘᴏʀᴛᴇʀ : {mention} ({reporter})\n\nMᴇꜱꜱᴀɢᴇ : {content}</b>", reply_markup=InlineKeyboardMarkup(btn))
                success = True
            elif len(content) >= 3:
                for admin in ADMINS:
                    btn = [[
                    ...
                    reported_post = await bot.send_message(chat_id=admin, text=f"<b>Rᴇᴘᴏʀᴛᴇʀ : {mention} ({reporter})\n\nMᴇꜱꜱᴀɢᴇ : {content}</b>", reply_markup=InlineKeyboardMarkup(btn))
                    success = True
            else:
                if len(content) < 3:
    ...
    if success:
        ...
        await message.reply_text("<b>Rᴇᴏ̨ᴜᴇsᴛ Hᴀꜱ Bᴇᴇɴ Aᴅᴅᴇᴅ.🥰\nPʟᴇᴀꜱᴇ Wᴀɪᴛ Fᴏʀ Sᴏᴍᴇ Tɪᴍᴇ\n\nJᴏɪɴ Cʜᴀɴɴᴇʟ Fɪʀꜱᴛ & Vɪᴇᴡ Rᴇᴏ̨ᴜᴇsᴛ.</b>", reply_markup=InlineKeyboardMarkup(btn))
...
async def deletemultiplefiles(bot, message):
    ...
    try:
        ...
        return await message.reply_text(f"<b>Hᴇʏ {message.from_user.mention}, Gɪᴠᴇ Mᴇ A Kᴇʏᴡᴏʀᴅ Aʟᴏɴɢ Wɪᴛʜ Tʜᴇ Cᴏᴍᴍᴀɴᴅ Tᴏ Dᴇʟᴇᴛᴇ Fɪʟᴇꜱ.</b>")
    k = await bot.send_message(chat_id=message.chat.id, text=f"<b>Fᴇᴛᴄʜɪɴɢ Fɪʟᴇꜱ Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ {keyword} Oɴ DB... Pʟᴇᴀꜱᴇ Wᴀɪᴛ...</b>")
    files, total = await get_bad_files(keyword)
    await k.delete()
    #await k.edit_text(f"<b>Fᴏᴜɴᴅ {total} Fɪʟᴇꜱ Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ {keyword} !\n\nDᴏ Yᴏᴜ Wᴀɴᴛ Tᴏ Dᴇʟᴇᴛᴇ?</b>")
    ...
    await message.reply_text(
        text=f"<b>Fᴏᴜɴᴅ {total} Fɪʟᴇꜱ Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ {keyword} !\n\nDᴏ Yᴏᴜ Wᴀɴᴛ Tᴏ Dᴇʟᴇᴛᴇ?</b>",
        reply_markup=InlineKeyboardMarkup(btn),
        parse_mode=enums.ParseMode.HTML
    )
